function BrowserFrame({ label, children, className = "" }) {
  return (
    ...
    >
      <div className="flex items-center gap-4 border-b border-ink/10 bg-ink/3 px-4 py-2.5">
        ...
        {label ? (
          <div className="min-w-0 flex-1 truncate rounded-md bg-ink/5 px-3 py-1 text-center text-xs text-ink/35">
            {label}
          </div>
        ) : null}
      </div>
